...
namespace KempDec.NetWindowsFirewall.Legacy
{
    /// <summary>
    ...
    public class NetWindowsFirewall
    {
        ...
        /// </summary>
        public static NetWindowsFirewall Instance
        {
            get
            {
                if (s_instance is null)
                {
                    s_instance = new NetWindowsFirewall();
                }
        ...
        private void AddIpRule(string name, IPAddress ipAddress, NET_FW_ACTION_ action,
            NET_FW_RULE_DIRECTION_ direction, string description = "")
        {
